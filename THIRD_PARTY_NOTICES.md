...
|---|---:|---|---|
| [TruffleHog](https://github.com/trufflesecurity/trufflehog) | `v3.95.9` | Used through TruffleHog's maintained pre-commit hook; built from the pinned upstream source in pre-commit's isolated Go environment. Not distributed or vendored by this repository. | [AGPL-3.0](https://github.com/trufflesecurity/trufflehog/blob/main/LICENSE) |
...
| [pre-commit](https://github.com/pre-commit/pre-commit) | Developer/consumer installed | Framework that consumes TruffleHog's maintained hook; not distributed by this repository. | [MIT](https://github.com/pre-commit/pre-commit/blob/main/LICENSE) |
