...
| [setuptools](https://github.com/pypa/setuptools) | `>=61` | PEP 517 build backend for the metadata-only root bridge and isolated TruffleHog hook package. | [MIT](https://github.com/pypa/setuptools/blob/main/LICENSE) |
| [wheel](https://github.com/pypa/wheel) | `>=0.37.1` | Builds a platform-specific local hook wheel so the downloaded executable is not treated as a universal artifact. | [MIT](https://github.com/pypa/wheel/blob/main/LICENSE.txt) |
