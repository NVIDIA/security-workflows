...
| [setuptools](https://github.com/pypa/setuptools) | `>=46.1.0` | PEP 517 build backend for the isolated hook package. | [MIT](https://github.com/pypa/setuptools/blob/main/LICENSE) |
