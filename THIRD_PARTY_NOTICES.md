...
| [setuptools](https://github.com/pypa/setuptools) | `>=61` (root bridge), `>=70.1,<77` (TruffleHog hook) | PEP 517 build backend; the hook uses its integrated wheel command to build a platform-specific local wheel. | [MIT](https://github.com/pypa/setuptools/blob/main/LICENSE) |
